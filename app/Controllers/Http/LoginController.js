...
class LoginController {
    ...
    async atualizaBarbeiros ({ params, request, response }) {
        ...
        barbeiros.cpf_barbeiro           = request.input('cpf_barbeiro')
        barbeiros.dataNascimento         = request.input('dataNascimento')
        barbeiros.telefone_barbeiro      = request.input('telefone_barbeiro')
        barbeiros.cep_barbeiro           = request.input('cep_barbeiro')
        barbeiros.rua_barbeiro           = request.input('rua_barbeiro')
        barbeiros.numeroCasa_barbeiro    = request.input('numeroCasa_barbeiro')
        barbeiros.bairro_barbeiro        = request.input('bairro_barbeiro')
        barbeiros.cidade_barbeiro        = request.input('cidade_barbeiro')
        barbeiros.estado_barbeiro        = request.input('estado_barbeiro')
